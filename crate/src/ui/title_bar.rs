...
pub fn show(ui: &mut egui::Ui, tab: &mut Tab, settings: &mut Settings, running: bool, stop_reason: Option<&str>, ctx: &egui::Context) {    let is_dark = settings.theme == crate::settings::Theme::Dark;
